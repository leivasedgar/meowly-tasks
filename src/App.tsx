        ...
        {displayedTasks.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 font-nunito font-medium text-base">
              {activeTab === 'todo' ? 'No mice to chase! Enjoy a nap.'  : 'No mice to chase! Enjoy a nap'} <i className={`fas ${activeTab === 'todo' ? 'fa-clipboard-list' : 'fa-clipboard-check'} text-4xl text-gray-300 mb-4`} />
            </p>
